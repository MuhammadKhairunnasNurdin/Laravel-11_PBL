...
class UpdateCivilianRequest extends FormRequest
{
    /**
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            'old_civilian_data' => decrypt($this->input('old_civilian_data')),
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            'NIK' => [
                ...
                'string',
                'regex:/^\d{16,20}$/',
                Rule::unique(Civilian::class)->ignore($this->route('civilian')->id)
            ],
            'NKK'=> [
                'bail',
                'required',
